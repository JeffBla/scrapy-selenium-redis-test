"""This module contains the ``SeleniumMiddleware`` scrapy middleware. Modified by scrapy-selenium package."""
"""The reaseon for the modification is to make the middleware compatible with the latest version of Selenium."""
...
class SeleniumMiddleware:
    ...
    def __init__(self, driver_name, driver_executable_path, driver_arguments,
        ...
        driver_kwargs = {'service': service, 'options': driver_options}
